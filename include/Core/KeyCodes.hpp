...
namespace lve {
    ...
    inline Noesis::Key glfwKeyToNoesis(int key) {
        if (key >= GLFW_KEY_A && key <= GLFW_KEY_Z)
            return static_cast<Noesis::Key>(key - GLFW_KEY_A + Noesis::Key_A);
        if (key >= GLFW_KEY_0 && key <= GLFW_KEY_9)
            return static_cast<Noesis::Key>(key - GLFW_KEY_0 + Noesis::Key_D0);
        if (key >= GLFW_KEY_F1 && key <= GLFW_KEY_F24)
            return static_cast<Noesis::Key>(key - GLFW_KEY_F1 + Noesis::Key_F1);
        if (key >= GLFW_KEY_KP_0 && key <= GLFW_KEY_KP_9)
            return static_cast<Noesis::Key>(key - GLFW_KEY_KP_0 + Noesis::Key_NumPad0);

        switch (key) {
            case GLFW_KEY_SPACE:        return Noesis::Key_Space;
            case GLFW_KEY_APOSTROPHE:   return Noesis::Key_Oem7;
            ...
            case GLFW_KEY_SLASH:        return Noesis::Key_Oem2;
            case GLFW_KEY_SEMICOLON:    return Noesis::Key_Oem1;
            case GLFW_KEY_EQUAL:        return Noesis::Key_OemPlus;
            case GLFW_KEY_LEFT_BRACKET: return Noesis::Key_Oem4;
            case GLFW_KEY_BACKSLASH:    return Noesis::Key_Oem5;
            case GLFW_KEY_RIGHT_BRACKET:return Noesis::Key_Oem6;
            case GLFW_KEY_GRAVE_ACCENT: return Noesis::Key_Oem3;
            ...
            case GLFW_KEY_MENU:         return Noesis::Key_Apps;
