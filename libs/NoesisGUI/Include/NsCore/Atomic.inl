...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline AtomicPointer::AtomicPointer(void* val): ptr(val)
{
}

////////////////////////////////////////////////////////////////////////////////////////////////////
inline void* AtomicPointer::LoadAcquire() const
{
#if NS_MULTITHREADING
    #ifdef NS_COMPILER_MSVC
        #if defined(_M_ARM)
            void* v = (void*)__iso_volatile_load32((int*)&ptr);
            __dmb(_ARM_BARRIER_ISH);
            return v;
        #elif defined(_M_ARM64)
            void* v = (void*)__iso_volatile_load64((__int64*)&ptr);
            __dmb(_ARM64_BARRIER_ISH);
            return v;
        #else
            void* v = ptr;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline void AtomicPointer::StoreRelease(void* val)
{
#if NS_MULTITHREADING
    #ifdef NS_COMPILER_MSVC
        #if defined(_M_ARM)
            __dmb(_ARM_BARRIER_ISH);
            __iso_volatile_store32((int*)&ptr, *((int*)&val));
        #elif defined(_M_ARM64)
            __dmb(_ARM64_BARRIER_ISH);
            __iso_volatile_store64((__int64*)&ptr, *((__int64*)&val));
        #else
            _ReadWriteBarrier();
            ptr = val;
        #endif
