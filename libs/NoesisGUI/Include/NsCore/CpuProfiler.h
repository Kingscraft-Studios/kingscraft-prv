...
#endif
#ifndef NS_PROFILER_SUPERLUMINAL
  #define NS_PROFILER_SUPERLUMINAL 0
#endif
    ...
    #define NS_PROFILE_CPU_FRAME FrameMark
    ...
    #define NS_PROFILE_CPU_FRAME OPTICK_FRAME("Frame")
    ...
    #define NS_PROFILE_CPU_FRAME NS_PROFILE_CPU("Frame")
    ...
    #define PROFILER_MEMORY_SIZE 256 * 1024 * 1024
    #define NS_PROFILE_CPU_INIT_DECLARE \
        static void* gProfilerMemory = aligned_alloc(4096, PROFILER_MEMORY_SIZE);
    #define NS_PROFILE_CPU_INIT \
        nn::profiler::InstallGraphicsHooks(); \
        nn::profiler::Initialize(gProfilerMemory, PROFILER_MEMORY_SIZE)
    #define NS_PROFILE_CPU_SHUTDOWN \
        nn::profiler::Finalize(); \
        free(gProfilerMemory)
    #define NS_PROFILE_CPU_FRAME nn::profiler::RecordHeartbeat(nn::profiler::Heartbeats_Main)
    #define NS_PROFILE_CPU(name) nn::profiler::ScopedCodeBlock(name)
#endif

#if NS_PROFILER_SUPERLUMINAL
    #include <superluminal/PerformanceAPI.h>
    #define NS_PROFILE_CPU_FRAME PerformanceAPI::InstrumentationScope("Frame")
    #define NS_PROFILE_CPU(name) PerformanceAPI::InstrumentationScope(name)
#endif
...
#ifndef NS_PROFILE_CPU_FRAME
    #define NS_PROFILE_CPU_FRAME NS_NOOP
#endif
