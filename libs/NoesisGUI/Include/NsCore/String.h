...
public:
    ...
    /// writes into the string via some external means such as strcpy or sprintf. This allows for
...
public:
    ...
    FixedString& operator=(const BaseString& str);
    FixedString& operator=(FixedString&& str);
    FixedString& operator=(BaseString&& str);
    ...
    /// Erases the contents of the string and deallocates memory
    void ClearShrink();
