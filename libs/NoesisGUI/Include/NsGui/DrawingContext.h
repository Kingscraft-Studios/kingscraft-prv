...
public:
    ...
    /// Draws the specified triangular mesh using the specified Brush
    void DrawMesh(Brush* brush, MeshData* mesh);
    ...
    /// Pushes the specified Blending mode
    void PushBlendingMode(BlendingMode mode);
