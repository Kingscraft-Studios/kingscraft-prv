...
NS_INTERFACE IRenderer: public Interface
{
    ...
    [[deprecated("Use RenderStereo(eyeMtx) instead")]]
    virtual void Render(const Matrix4& eyeMtx, bool flipY = false, bool clear = false) = 0;
    ...
    virtual void RenderStereo(const Matrix4& eyeMtx, bool flipY = false, bool clear = false) = 0;

    [[deprecated("Use RenderStereo(leftEyeMtx, rightEyeMtx) instead")]]
    virtual void Render(const Matrix4& projection, const Matrix4& leftEyeMtx,
        const Matrix4& rightEyeMtx, bool flipY = false, bool clear = false) = 0;
    ...
    /// that matrix
    virtual void RenderStereo(const Matrix4& leftEyeMtx, const Matrix4& rightEyeMtx,
        bool flipY = false, bool clear = false) = 0;
