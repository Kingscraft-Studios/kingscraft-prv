...
/// and/or schemes (scheme:///path) are also available
...
NS_GUI_CORE_API void SetSchemeAssemblyXamlProvider(const char* scheme, const char* assembly,
...
NS_GUI_CORE_API void SetSchemeAssemblyTextureProvider(const char* scheme, const char* assembly,
...
NS_GUI_CORE_API void SetSchemeAssemblyFontProvider(const char* scheme, const char* assembly,
