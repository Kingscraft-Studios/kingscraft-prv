...
namespace lve {
    ...
    VkResult SwapChain::acquireNextImage(uint32_t *imageIndex) {
        ...
        VkResult result = vkAcquireNextImageKHR(
                ...
                swapChain,
                std::numeric_limits<uint64_t>::max(),
                imageAvailableSemaphores[currentFrame],  // must be not signaled semaphore
                VK_NULL_HANDLE,
                imageIndex);
    ...
    VkResult SwapChain::submitCommandBuffers(
        ...
        // Wait for the previous frame using this image
        ...
        // Reset a fence before submitting work
    ...
    void SwapChain::createSwapChain() {
        ...
        // images with vkGetSwap chainImagesKHR, then resize the container and finally call it again to
    ...
    void SwapChain::createSyncObjects() {
        ...
        // renderFinished is now per-image
